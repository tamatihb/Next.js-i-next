				...
				<div className="flex justify-between text-center   font-semibold italic ">
					...
					<div className="flex flex-col md:ml-20 mx-10 mt-10">
						...
						<p className="text-left font-normal font mb-5 flex-wrap bg-clip-text text-transparent text-2xl bg-white">
							Lorem, ipsum dolor sit <span className="before:block before:absolute before:-inset-1 before:-skew-y-2 before:bg-cyan-300 relative inline-block">
    						<span className="relative text-white">!next Officiis</span>
 							</span> amet consectetur adipisicing elit. 
							...
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae quod facere sapiente <span className="before:block before:absolute before:-inset-1 before:-skew-y-2 before:bg-cyan-300 relative inline-block">
    						<span className="relative text-white">itaque repudiandae.</span>
  							</span> excepturi quidem ipsum  Placeat, veritatis quam! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum vero error iusto laborum harum saepe? Lorem ipsum dolor sit, amet consectetur adipisicing elit. At, quaerat!
						</p>
